          ...
          <motion.div variants={itemVariants} className="lg:col-span-1 bg-card/80 backdrop-blur-xl rounded-[24px] p-6 shadow-xl border border-border h-fit flex flex-col relative overflow-hidden transition-colors duration-300">
            ...
            <div className="relative z-10 flex-1">
              ...
              {isCustomOption && (
                ...
                >
                  <Input
                    ...
                    className={`bg-background/50 text-foreground placeholder:text-muted-foreground rounded-[16px] h-14 text-lg focus-visible:ring-offset-0 focus-visible:ring-2 focus-visible:ring-[var(--ocean-blue-accent)] transition-colors ${
                      isButtonDisabled ? 'border-[var(--destructive)]/60 focus-visible:ring-[var(--destructive)]' : 'border-border'
                    }`}
                    min="1"
                  />
              ...
              <Button
                ...
                className={`w-full mt-8 rounded-[16px] h-14 text-lg font-semibold shadow-lg transition-all duration-300 ${
                  isButtonDisabled 
                    ? 'bg-muted text-muted-foreground cursor-not-allowed hover:bg-muted hover:scale-100' 
                    : 'bg-[var(--ocean-blue-accent)] hover:opacity-90 text-white hover:shadow-[var(--ocean-blue-accent)]/25 hover:scale-[1.02] active:scale-[0.98]'
                }`}
              >
